...
const ProcessSection = () => (
  <section id="process" className="py-24 px-6">
    <div className="max-w-6xl mx-auto">
      <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">Work Process</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {steps.map((s) => (
          <div key={s.num} className="p-6 rounded-2xl glass-card hover:border-primary/40 hover:shadow-lg transition-all duration-300">
